...
const MENU_OPTS = [
  ...
  {
    value: "Royal Feast",
    label: "Royal Feast — Full traditional multi-course meal",
  },
  {
    value: "Garden Delight",
    label: "Garden Delight — Fresh salads, BBQ & desserts",
  },
  {
    value: "Modern Fusion",
    label: "Modern Fusion — Contemporary international cuisine",
  },
...
const DECOR_OPTS = [
  { value: "", label: "No preference" },
  {
    ...
    label: "Classic Elegance — White & gold traditional setup",
  },
  {
    value: "Floral Fantasy",
    label: "Floral Fantasy — Lush flower arrangements throughout",
  },
  {
    value: "Royal Grandeur",
    label: "Royal Grandeur — Full luxury premium setup",
  },
  {
    value: "Modern Minimalist",
    label: "Modern Minimalist — Clean, contemporary aesthetic",
  },
...
const inp = (err) => ({
  ...
  padding: "10px 13px",
  borderRadius: "9px",
  border: `1.5px solid ${err ? ERR : BORDER}`,
  fontSize: ".9rem",
  color: TEXT,
  background: "#fff",
  outline: "none",
...
const Label = ({ children, required }) => (
  ...
  >
    {children}
    {required && <span style={{ color: GOLD, marginLeft: "3px" }}>*</span>}
  </label>
);
...
const ErrMsg = ({ msg }) =>
  msg ? (
    <p
      className="rb-err"
      style={{ color: ERR, fontSize: ".75rem", marginTop: "5px" }}
    >
      {msg}
    </p>
  ) : null;
...
const Card = ({ title, subtitle, children }) => (
  ...
  >
    <div style={{ marginBottom: "22px" }}>
      <h2 style={{ color: TEXT, fontSize: "1rem", fontWeight: 700 }}>
        {title}
      </h2>
      {subtitle && (
        <p
...
function Confirmation({ form, ref_, navigate }) {
  ...
  const rows = [
    {
      label: "Date",
      value: new Date(form.date + "T12:00:00").toLocaleDateString("en-US", {
        weekday: "long",
        day: "numeric",
        month: "long",
        year: "numeric",
    ...
    },
    {
      label: "Time Slot",
      value: slotLabel
        ? `${SLOTS.find((s) => s.id === form.slot)?.icon || ""} ${slotLabel}`
        : "—",
    },
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: "rgba(255,255,255,.45)", fontSize: ".85rem" }}>
          Booking Request
        </span>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ color: "#fff", fontSize: "1.6rem", lineHeight: 1 }}
              >
                ✓
              </span>
            </div>
          ...
          <div style={{ padding: "24px 36px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
              {rows.map(({ label, value }, i) => (
                ...
                >
                  <span
                    style={{ fontSize: ".85rem", color: MUTED, flexShrink: 0 }}
                  >
                    {label}
                  </span>
                  <span
            ...
            >
              ...
              <p style={{ fontSize: ".84rem", color: MUTED }}>
          ...
          >
            <button
              ...
              onMouseOver={(e) =>
                (e.currentTarget.style.background = "#2e2e2a")
              }
...
export default function RequestBooking() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        hall: form.hall || "No preference",
        eventType: form.eventType,
        guests: Number(form.capacity),
        slot: form.slot,
        menuPackage: form.menu || "",
        decorPackage: form.decor || "",
        message: form.notes || "",
      };
      const res = await createBookingRequest(payload);
      setRefNumber(res.data.requestId);
      setSubmitted(true);
    } catch (err) {
      setErrors({
  ...
  if (submitted)
    return <Confirmation form={form} ref_={refNumber} navigate={navigate} />;
    ...
    <>
      ...
      <div className="rb-root">
        ...
        >
          ...
          >
            Fill in the details below and our team will confirm availability and
        ...
        >
          ...
          <Card
            ...
            subtitle="We'll reach out to confirm your booking."
          >
            <div
              style={{
                display: "grid",
            ...
            >
              ...
              <div>
                ...
                {errors.slot && (
                  <p
                    className="rb-err"
                    style={{ color: ERR, fontSize: ".75rem", marginTop: "6px" }}
                  >
                    {errors.slot}
                  </p>
                )}
          ...
          <Card
            ...
            subtitle="Optional — anything else you'd like us to know?"
          >
            <textarea
              className="rb-input"
              style={{
          ...
          <div style={{ marginTop: "8px" }}>
            ...
            >
              By submitting, you agree that this is an inquiry — not a confirmed
              booking. A team member will contact you to confirm availability
              and payment.
            </p>
          </div>
        </form>
